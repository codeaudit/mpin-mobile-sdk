...
#define COCOAPODS_VERSION_MINOR_HockeySDK 8
...
#define COCOAPODS_VERSION_MINOR_HockeySDK_AllFeaturesLib 8
#define COCOAPODS_VERSION_PATCH_HockeySDK_AllFeaturesLib 2
