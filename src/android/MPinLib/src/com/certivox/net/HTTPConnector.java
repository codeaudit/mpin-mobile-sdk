...
public class HTTPConnector implements IHTTPRequest {
	...
	protected HttpURLConnection getConnection(String serviceURL, boolean output)
		...
		if (serviceURL.startsWith("/"))
			serviceURL = "http://ec2-54-77-232-113.eu-west-1.compute.amazonaws.com"
					+ serviceURL;
	...
	protected String sendRequest(String serviceURL, String http_method,
			String requestBody, Hashtable<String, String> requestProperties)
	...
	protected String sendRequest(String serviceURL, String http_method,
			String requestBody) throws IOException, HTTPErrorException {
